    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "start_year": {"type": ["integer", "null"], "description": "Year started. Send null if unknown — never 0."},
                "end_year": {
                    "type": ["integer", "null"],
                    "description": "Year ended. Send null if current or unknown — never 0.",
                },
    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "field": {"type": ["string", "null"], "description": "Major or field of study. Send null if unknown."},
                "year": {"type": ["integer", "null"], "description": "Graduation year. Send null if unknown — never 0."},
            },
    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "start_year": {
                    "type": ["integer", "null"],
                    "description": "Corrected start year (omit if unchanged). Send null if unknown — never 0.",
                },
                "end_year": {
                    "type": ["integer", "null"],
                    "description": "Corrected end year (omit if unchanged). Send null if unknown — never 0.",
                },
    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "field": {
                    "type": ["string", "null"],
                    "description": "Corrected field of study (omit if unchanged). Send null if unknown.",
                },
                "year": {
                    "type": ["integer", "null"],
                    "description": "Corrected graduation year (omit if unchanged). Send null if unknown — never 0.",
                },
            },
