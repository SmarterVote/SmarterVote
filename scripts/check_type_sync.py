...
CHECKED_MODELS: Dict[str, Type[BaseModel]] = {
    ...
    "ForecastPanelEstimate": shared_models.ForecastPanelEstimate,
...
FRONTEND_ONLY_OR_OTHER_BACKEND_TYPES: Dict[str, str] = {
    ...
    "ResearchResultState": "Mirrors the result-state Literal in races-api ResearchCheckpointRequest; the request model is service-local.",
    "ResearchManifestEntry": "Mirrors the committed 2026 research manifest row consumed through races-api.",
    "ResearchCheckpoint": "Mirrors the service-local research checkpoint document and API response.",
    "ResearchArtifactStatus": "Provenance-labelled artifact projection composed by the research status endpoint.",
    "ResearchProgramRow": "Composite admin status row produced by the research status endpoint.",
    "ResearchProgramStatus": "Top-level research status endpoint response shape.",
    "ResearchCheckpointInput": "Frontend request projection for the service-local ResearchCheckpointRequest model.",
