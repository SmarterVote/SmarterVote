...
echo ""
echo "2. Ensure infra/functions-agent-source.zip was rebuilt by the deployment workflow for the agent Cloud Function"
echo "3. Update the races-api Cloud Run service if you changed the image tag"
echo "4. Test the API endpoints and queue a race through the admin UI"
